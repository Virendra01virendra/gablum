                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-f7d76a77d81a6b4b0ff3379252c691a0"' : 'data-target="#xs-components-links-module-AppModule-f7d76a77d81a6b4b0ff3379252c691a0"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-f7d76a77d81a6b4b0ff3379252c691a0"' :
                                            'id="xs-components-links-module-AppModule-f7d76a77d81a6b4b0ff3379252c691a0"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/DashboardModule.html" data-type="entity-link">DashboardModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-DashboardModule-c5fadff4e0aea0c9b3d2d4f017bc6ea9"' : 'data-target="#xs-components-links-module-DashboardModule-c5fadff4e0aea0c9b3d2d4f017bc6ea9"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-DashboardModule-c5fadff4e0aea0c9b3d2d4f017bc6ea9"' :
                                            'id="xs-components-links-module-DashboardModule-c5fadff4e0aea0c9b3d2d4f017bc6ea9"' }>
                                            <li class="link">
