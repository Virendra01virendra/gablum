...
import { MatFormFieldModule, MatToolbarModule, MatInputModule} from '@angular/material' ;
...
describe('NewProposalForm1Component', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [ BrowserAnimationsModule, MatFormFieldModule, MatInputModule, MatToolbarModule, ReactiveFormsModule, RouterTestingModule]
    })
    .compileComponents();
  }));
